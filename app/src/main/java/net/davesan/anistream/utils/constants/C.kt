package net.davesan.anistream.utils.constants

class C {
    companion object{

        const val GIT_DOWNLOAD_URL = "https://github.com/dstasio/AniStream/"
        ...
        const val ORIGIN  = "https://gogoanime.sh"
        const val REFERER = "https://gogoanime.sh/"
