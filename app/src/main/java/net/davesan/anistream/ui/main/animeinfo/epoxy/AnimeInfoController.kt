package net.davesan.anistream.ui.main.animeinfo.epoxy

import android.content.Intent
import android.view.View
import com.airbnb.epoxy.TypedEpoxyController
import net.davesan.anistream.ui.main.player.VideoPlayerActivity
import net.davesan.anistream.utils.model.EpisodeModel

class AnimeInfoController : TypedEpoxyController<ArrayList<EpisodeModel>>(){
    var animeName: String = ""
    private lateinit var isWatchedHelper: net.davesan.anistream.utils.helper.WatchedEpisode
    ...
    fun setAnime(animeName: String){
        ...
        isWatchedHelper = net.davesan.anistream.utils.helper.WatchedEpisode(animeName)
    }
